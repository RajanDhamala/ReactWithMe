...
function Weathercard({location,time,message,temp,icon,humidity,wind}){
    return(
        ...
        <div className="bg-[#f0f0f0] w-96 min-h-52 m-2 border-2">
            <h1 className="text-black text-2xl text-start ml-4 mt-2">{location}</h1>
            <div className="grid grid-cols-12 gap-2">
            <p className="pl-2 text-start ml-4 mt-2 col-span-5 overflow-hidden">{time}</p>
            <p className=" pl-2 text-start col-span-7 mt-2  overflow-hidden">{message}</p>
            </div>
